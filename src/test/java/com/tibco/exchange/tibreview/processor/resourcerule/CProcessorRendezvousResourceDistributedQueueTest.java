...
public class CProcessorRendezvousResourceDistributedQueueTest {
	...
	public void testCProcessorRendezvousResourceDistributedQueueTest() {
		...
		try {
			...
			fileresource = new TIBResource("src/test/resources/FileResources/RendezvousResourceDistributedQueue.rvResource");
			fileresource.toString();
			LOGGER.info(fileresource.toString());
			assertTrue(fileresource.toString().equals("TIBResource [filePath=src/test/resources/FileResources/RendezvousResourceDistributedQueue.rvResource, type=rvsharedresource:RVResource]"));
			
			Tibrules tibrules= RulesParser.getInstance().parseFile("src/test/resources/FileResources/xml/RendezvousResourceDistributedQueue.xml");
