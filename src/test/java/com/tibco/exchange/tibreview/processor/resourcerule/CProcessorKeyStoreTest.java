...
public class CProcessorKeyStoreTest {
	...
	public void testCProcessorKeyStoreTest() {
		...
		try {
			...
			fileresource = new TIBResource("src/test/resources/FileResources/KeystoreProviderResource.keystoreProviderResource");
			fileresource.toString();
			System.out.println(fileresource.toString());
			assertTrue(fileresource.toString().equals("TIBResource [filePath=src/test/resources/FileResources/KeystoreProviderResource.keystoreProviderResource, type=keystore:KeystoreConfiguration]"));
